...
<img src="Numeratore.png" alt="The two Numeratore switches in the Inspector palette, beside the font version they read, and the name of the file an export writes: YourFileName-1.501.otf." title="Numeratore Screenshot" width="520">
